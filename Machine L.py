...
'''
SQLQuery_node1738271800631 = sparkSqlQuery(glueContext, query = SqlQuery6356, mapping = {"stt":step_trainer_trusted_node1738270137457, "cuc":customer_curated_node1738270522141, "act":accelerometer_trusted_node1738270772396}, transformation_ctx = "SQLQuery_node1738271800631")

# Script generated for node machine_learning_curated
EvaluateDataQuality().process_rows(frame=SQLQuery_node1738271800631, ruleset=DEFAULT_DATA_QUALITY_RULESET, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1738262772389", "enableDataQualityResultsPublishing": True}, additional_options={"dataQualityResultsPublishing.strategy": "BEST_EFFORT", "observations.scope": "ALL"})
...
machine_learning_curated_node1738272515209.writeFrame(SQLQuery_node1738271800631)
job.commit()